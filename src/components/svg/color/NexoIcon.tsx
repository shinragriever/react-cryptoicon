...
const NexoIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g fill="none">
      <circle cx={16} cy={16} r={16} fill="#1A4199" />
      <g fill="#FFF">
        <path d="m10.676 7.125 10.732 6.191v6.319L5 10.159l5.265-3.034a.42.42 0 0 1 .42 0" opacity={0.7} />
        ...
        <path d="m26.881 22.792-5.264 3.033a.44.44 0 0 1-.42 0l-10.732-6.19v-6.328l16.416 9.485z" opacity={0.9} />
