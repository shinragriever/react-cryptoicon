...
const CixIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32" {...props}>
    <g fill="none">
      ...
      <g fill="#FFF">
        ...
        <path d="m18.883 20.843-.657.364-2.404-3.21V9.894h3.06v10.949zm-8.654-.607-3.06 1.612V11.312h3.06v8.924z" opacity={0.5} />
      </g>
    </g>
  </svg>
);
export default CixIcon;
